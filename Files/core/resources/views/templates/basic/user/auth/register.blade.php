            ...
            <form class="mt-5" action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label>@lang('First Name') <span class="text--base">*<span></label>
                        <input type="text" class="form-control" name="firstname" value="{{ old('firstname') }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>@lang('Last Name') <span class="text--base">*<span></label>
                        <input type="text" class="form-control" name="lastname" value="{{ old('lastname') }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>@lang('Username') <span class="text--base">*<span></label>
                        <input id="username" type="text" class="form-control checkUser" name="username" value="{{ old('username') }}" required>
                        <small class="text-danger usernameExist"></small>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>@lang('Email Address') <span class="text--base">*<span></label>
                        <input id="email" type="email" class="form-control form-control checkUser" name="email" value="{{ old('email') }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>@lang('Country') <span class="text--base">*<span></label>
                    ...
                    <div class="form-group col-sm-6">
                        <label>@lang('Mobile') <span class="text--base">*<span></label>
                    ...
                    <div class="form-group hover-input-popup col-sm-6">
                        <label>@lang('Password') <span class="text--base">*<span></label>
                    ...
                    <div class="form-group col-sm-6">
                        <label>@lang('Confirm Password') <span class="text--base">*<span></label>
                ...
                @if($general->agree)
                    <div class="col-lg-12 form-group">
                        <div class="form-group custom-checkbox">
                            ...
                            <label for="agree">@lang('I have read agreed with')</label>
                ...
                <div>
                    <button type="submit" id="recaptcha" class="cmn-btn w-100">@lang('Register Now')</button>
                </div>
                <div class="row align-items-center mt-3">
                    <div class="col-lg-12">
                    <p>@lang('Already Have An Account')? <a href="{{route('user.login')}}" class="mt-3 base--color">Login now</a></p>
                    </div>
                </div>
            </form>
          </div>
