            ...
            <div class="col-md-12">
                <div class="custom--card">
                    <div class="card-header bg-dark d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <button class="btn btn-danger close-button" type="button" title="@lang('Close Ticket')" data-toggle="modal" data-target="#DelModal"><i class="las la-times"></i>
                        </button>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-between">
                                        ...
                                        <div class="row justify-content-between">
                                            <div class="col-md-11">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="attachments[]" id="inputAttachments" class="form-control custom-input-field"/>
                                            ...
                                            <div class="col-md-1 pt-4">
                                                <a href="javascript:void(0)" class="btn btn-danger btn-round mt-3 addFile">
                                    ...
                                    <div class="col-md-3 pt-4">
                                        <button type="submit" class="btn btn-success custom-success mt-3 btn-block">
