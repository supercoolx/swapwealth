                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        @foreach ($wallets as $item)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><b>{{__($item->crypto->code)}}</b> @lang('Balance')</span>
                                <span class="font-weight-bold">{{__($item->crypto->symbol)}} {{showAmount($item->balance,8)}}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="row mb-none-30">
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalDeposit}}</span>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Total Withdraw Count')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <form action="{{route('admin.users.add.sub.balance', $user->id)}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label>@lang('Select Wallet')<span class="text-danger">*</span></label>
                                <select class="form-control" name="wallet_id" id="wallet" required>
                                    @foreach ($wallets as $item)
                                        <option value="{{$item->id}}">{{__($item->crypto->code)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label>@lang('Details')<span class="text-danger">*</span> <code>(@lang('Max 255 Characters'))</code></label>
                                <textarea name="details" rows="5" class="form-control" placeholder="@lang('Enter details')" required></textarea>
                            </div>
                        </div>
                    </div>
