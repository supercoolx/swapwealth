    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.ad*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ad.limit*')}}">
                                <a href="{{route('admin.ad.limit.index')}}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Advertisement Limit')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive(['admin.ad.index', 'admin.ad.view', 'admin.ad.update', 'admin.ad.search']) }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.trade.request*',3)}}">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.trade.request*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.request.index')}}">
                                <a href="{{route('admin.trade.request.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Requests')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.trade.request.reported')}}">
                                <a href="{{route('admin.trade.request.reported')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.trade.request.completed')}}">
                                <a href="{{route('admin.trade.request.completed')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.fiat*')}}">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.payment.window*')}}">
                    <a href="{{route('admin.payment.window.index')}}" class="nav-link ">
